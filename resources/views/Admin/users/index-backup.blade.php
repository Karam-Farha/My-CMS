                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @can('user_delete')
                                <form class="me-4" action="{{ route('users.destroy', $item->id) }}" method="POST" onsubmit="return confirm('{{ __('Are you sure, you want to delete This Item?') }}');" style="display: inline-block;">
